...
def extract_fanfic(link_list):
    ...
    for link in link_list:
        ...
        if fanfik.status_code == 200:
            ...
            pre_elements = raw_fanfic.find_all('pre')
    ...
    while True:
        try:
            ...
            if NFZ == 'quit':
                ...
                print(f'{TextColors.ERROR}Coś ci nie wyszło z tym linkiem - spróbuj się zacząć od https://{TextColors.ENDCOLOR}')
        except Exception as ex:
            print(f'{TextColors.ERROR}Wystąpił nieoczekiwany błąd: {TextColors.ENDCOLOR}{ex}')

    extract_fanfic(url_list)
